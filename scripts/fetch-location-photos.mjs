...
const places = [
  ...
  ["송도제일밀면", "songdo-jeil-milmyeon", "송도제일밀면 부산"],
  ["송도해솥", "songdo-haesot", "송도해솥 부산"],
  ["송도키친", "songdo-kitchen", "송도키친 부산"],
  ["송도1913", "songdo-1913", "송도1913 부산"],
  ["그린하우스", "greenhouse-gamcheon", "그린하우스 감천문화마을"],
  ["고니스커피", "gonys-coffee", "고니스커피 남포동"],
  ["힙컵", "hipcup", "힙컵 남포동"],
